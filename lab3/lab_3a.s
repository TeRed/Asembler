...
#----------------------------------------------------------------
	...
	.equ	stderr,		0x02	# standard error
...
file_n:				# file name (0 terminated)
	.string	"testfile.txt"	### Na końcu dodane będzie 0, zakończenie string (przy użyciu .ascii należy jawnie dodać '\0')
...
txtlen:				# size of written data
	.quad		( . - txtline ) ### Adres bieżącego miejsca w czasie kompilacji (można równie dobrze użyć 'txtlen')
