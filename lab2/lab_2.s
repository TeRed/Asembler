...
_start:
	...
	MOVB	arg1,%al
	ORB	arg2,%al ### Logiczne OR (dla Byte)
	MOVB	%al,result
	MOV	$ortxt,%rsi
	CALL	disp_line
...
#----------------------------------------------------------------
	...
	.type disp_line,@function ### dyrektywa type - definiuje funkcję
...
insert1:
	...
	MOVB	tmp,%al
	SHR	$4,%al	### Przesunięcie bitowe logiczne
	CMPB	$10,%al	### Ustawiamy ewentualnie flagę 0
	JB	digit2	### jeśli jest (%al < 10) to jump do digit2
	ADDB	$('A'-0x0A),%al
	JMP	insert2
digit2:
	ADDB	$'0',%al
